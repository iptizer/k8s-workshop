...
When everything went well, nextcloud can be visited on [nextcloud-127-0-0-1.nip.io](https://nextcloud-127-0-0-1.nip.io). "username=admin" and "password=password123".
